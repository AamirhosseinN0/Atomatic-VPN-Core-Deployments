# singbox-pipe (ubuntu-22.04) — run 34405191591
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 172.208.153.212
...
[+] Detected public IPv4: 172.208.153.212
...
----------------------------------------------------------------------
  Server                 vpn.example.com (172.208.153.212)
...
----------------------------------------------------------------------
  Copy the bundle to your PC
    scp -r root@172.208.153.212:/root/singbox-clients .
----------------------------------------------------------------------
...
● sing-box.service - sing-box service
    ...
    Drop-In: /etc/systemd/system/sing-box.service.d
             └─10-limits.conf
     Active: active (running) since Wed 2026-09-09 21:08:47 UTC; 2s ago
       Docs: https://sing-box.sagernet.org
   Main PID: 3093 (sing-box)
      Tasks: 9 (limit: 19155)
     Memory: 9.0M
        CPU: 51ms
     CGroup: /system.slice/sing-box.service
             └─3093 /usr/bin/sing-box -D /var/lib/sing-box -C /etc/sing-box run

Sep 09 21:08:47 runnervm9xg2d systemd[1]: Started sing-box service.
Sep 09 21:08:47 runnervm9xg2d sing-box[3093]: +0000 2026-09-09 21:08:47 INFO network: updated default interface eth0, index 2
Sep 09 21:08:47 runnervm9xg2d sing-box[3093]: +0000 2026-09-09 21:08:47 INFO network: updated network environment: gateway 10.1.0.1, gateway_mac 12:34:56:78:9a:bc
Sep 09 21:08:47 runnervm9xg2d sing-box[3093]: +0000 2026-09-09 21:08:47 INFO inbound/vless[vless-reality-in]: tcp server started at [::]:443
Sep 09 21:08:47 runnervm9xg2d sing-box[3093]: +0000 2026-09-09 21:08:47 INFO inbound/shadowsocks[ss2022-in]: tcp server started at [::]:8388
Sep 09 21:08:47 runnervm9xg2d sing-box[3093]: +0000 2026-09-09 21:08:47 INFO inbound/shadowsocks[ss2022-in]: udp server started at [::]:8388
Sep 09 21:08:47 runnervm9xg2d sing-box[3093]: +0000 2026-09-09 21:08:47 INFO sing-box started (0.00s)
```
...
-rw-------  1 root root  789 Sep  9 21:08 README.txt
-rw-------  1 root root 1571 Sep  9 21:08 client-clash.yaml
-rw-------  1 root root 2350 Sep  9 21:08 client-singbox.json
-rw-------  1 root root  336 Sep  9 21:08 links.txt
-rw-------  1 root root  448 Sep  9 21:08 subscription.txt
```
