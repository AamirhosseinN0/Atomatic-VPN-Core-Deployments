# xray (ubuntu-24.04) — run 34364536926
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 158.23.147.97
  Xray channel             latest
...
[+] Detected public IPv4: 158.23.147.97
[!] DNS: vpn.example.com -> <none> (expected 158.23.147.97); Let's Encrypt HTTP-01 may fail.
...
----------------------------------------------------------------------
  Server                 vpn.example.com (158.23.147.97)
  Xray                   26.9.9 (latest)
  Port mode              dedicated
...
----------------------------------------------------------------------
  Manage
    ...
    journalctl -u xray -f
----------------------------------------------------------------------
    scp -r root@158.23.147.97:/root/xray-clients .
----------------------------------------------------------------------
...
● xray.service - Xray Service
    ...
    Drop-In: /etc/systemd/system/xray.service.d
     ...
     Active: active (running) since Wed 2026-09-09 14:35:48 UTC; 2s ago
       Docs: https://github.com/xtls
   Main PID: 3698 (xray)
      Tasks: 9 (limit: 19151)
     Memory: 15.1M (peak: 15.2M)
        CPU: 50ms
     CGroup: /system.slice/xray.service
             └─3698 /usr/local/bin/xray run -config /usr/local/etc/xray/config.json

Sep 09 14:35:48 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 09 14:35:48 runnervmlun5p xray[3698]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 09 14:35:48 runnervmlun5p xray[3698]: A unified platform for anti-censorship.
Sep 09 14:35:48 runnervmlun5p xray[3698]: 2026/09/09 14:35:48.801597 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 09 14:35:48 runnervmlun5p xray[3698]: 2026/09/09 14:35:48.802219 [Warning] infra/conf: REALITY: Choosing "www.microsoft.com" as the target will increase the likelihood of your server's IP being blocked by the GFW
Sep 09 14:35:48 runnervmlun5p xray[3698]: 2026/09/09 14:35:48.802805 [Warning] common/errors: The feature Shadowsocks (with no Forward Secrecy, etc.) is deprecated, not recommended for using and might be removed. Please migrate to VLESS Encryption as soon as possible.
Sep 09 14:35:48 runnervmlun5p xray[3698]: 2026/09/09 14:35:48.813362 [Warning] core: Xray 26.9.9 started
```

## Service journal (last 60 lines)
```
Sep 09 14:35:37 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:37 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 09 14:35:37 runnervmlun5p xray[2889]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 09 14:35:37 runnervmlun5p xray[2889]: A unified platform for anti-censorship.
Sep 09 14:35:37 runnervmlun5p xray[2889]: 2026/09/09 14:35:37.911481 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 09 14:35:37 runnervmlun5p xray[2889]: 2026/09/09 14:35:37.911771 [Warning] core: Xray 26.9.9 started
Sep 09 14:35:37 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:39 runnervmlun5p systemd[1]: Stopping xray.service - Xray Service...
Sep 09 14:35:39 runnervmlun5p systemd[1]: xray.service: Deactivated successfully.
Sep 09 14:35:39 runnervmlun5p systemd[1]: Stopped xray.service - Xray Service.
Sep 09 14:35:41 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:44 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:46 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:46 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:46 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:47 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:48 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 14:35:48 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 09 14:35:48 runnervmlun5p xray[3698]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 09 14:35:48 runnervmlun5p xray[3698]: A unified platform for anti-censorship.
Sep 09 14:35:48 runnervmlun5p xray[3698]: 2026/09/09 14:35:48.801597 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
...
-rw-------  1 root root 1655 Sep  9 14:35 README.txt
-rw-------  1 root root 1826 Sep  9 14:35 client-clash.yaml
-rw-------  1 root root 2739 Sep  9 14:35 client-singbox.json
-rw-------  1 root root 2339 Sep  9 14:35 client-xray.json
-rw-------  1 root root  441 Sep  9 14:35 links.txt
-rw-------  1 root root  588 Sep  9 14:35 subscription.txt
```
