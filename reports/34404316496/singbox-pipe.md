# singbox-pipe (ubuntu-22.04) — run 34404316496
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 52.159.247.59
...
[+] Detected public IPv4: 52.159.247.59
...
----------------------------------------------------------------------
  Server                 vpn.example.com (52.159.247.59)
...
----------------------------------------------------------------------
  Copy the bundle to your PC
    scp -r root@52.159.247.59:/root/singbox-clients .
----------------------------------------------------------------------
...
● sing-box.service - sing-box service
    ...
    Drop-In: /etc/systemd/system/sing-box.service.d
             └─10-limits.conf
     Active: active (running) since Wed 2026-09-09 21:00:08 UTC; 2s ago
       Docs: https://sing-box.sagernet.org
   Main PID: 3116 (sing-box)
      Tasks: 9 (limit: 19154)
     Memory: 8.7M
        CPU: 59ms
     CGroup: /system.slice/sing-box.service
             └─3116 /usr/bin/sing-box -D /var/lib/sing-box -C /etc/sing-box run

Sep 09 21:00:08 runnervm7g52i systemd[1]: Started sing-box service.
Sep 09 21:00:08 runnervm7g52i sing-box[3116]: +0000 2026-09-09 21:00:08 INFO network: updated default interface eth0, index 2
Sep 09 21:00:08 runnervm7g52i sing-box[3116]: +0000 2026-09-09 21:00:08 INFO network: updated network environment: gateway 10.1.0.1, gateway_mac 12:34:56:78:9a:bc
Sep 09 21:00:08 runnervm7g52i sing-box[3116]: +0000 2026-09-09 21:00:08 INFO inbound/vless[vless-reality-in]: tcp server started at [::]:443
Sep 09 21:00:08 runnervm7g52i sing-box[3116]: +0000 2026-09-09 21:00:08 INFO inbound/shadowsocks[ss2022-in]: tcp server started at [::]:8388
Sep 09 21:00:08 runnervm7g52i sing-box[3116]: +0000 2026-09-09 21:00:08 INFO inbound/shadowsocks[ss2022-in]: udp server started at [::]:8388
Sep 09 21:00:08 runnervm7g52i sing-box[3116]: +0000 2026-09-09 21:00:08 INFO sing-box started (0.00s)
```
...
-rw-------  1 root root  787 Sep  9 21:00 README.txt
-rw-------  1 root root 1571 Sep  9 21:00 client-clash.yaml
-rw-------  1 root root 2350 Sep  9 21:00 client-singbox.json
-rw-------  1 root root  332 Sep  9 21:00 links.txt
-rw-------  1 root root  444 Sep  9 21:00 subscription.txt
```
