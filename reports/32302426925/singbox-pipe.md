# singbox-pipe (ubuntu-22.04) — run 32302426925
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 52.159.245.145
...
[+] Detected public IPv4: 52.159.245.145
...
----------------------------------------------------------------------
  Server                 vpn.example.com (52.159.245.145)
...
----------------------------------------------------------------------
  Copy the bundle to your PC
    scp -r root@52.159.245.145:/root/singbox-clients .
----------------------------------------------------------------------
  3 warning(s) above — scroll up.
----------------------------------------------------------------------
...
● sing-box.service - sing-box service
    ...
    Drop-In: /etc/systemd/system/sing-box.service.d
             └─10-limits.conf
     Active: active (running) since Wed 2026-08-19 21:16:50 UTC; 2s ago
       Docs: https://sing-box.sagernet.org
   Main PID: 3612 (sing-box)
      Tasks: 9 (limit: 19154)
     Memory: 5.0M
        CPU: 23ms
     CGroup: /system.slice/sing-box.service
             └─3612 /usr/bin/sing-box -D /var/lib/sing-box -C /etc/sing-box run

Aug 19 21:16:50 runnervmec1zy systemd[1]: Started sing-box service.
Aug 19 21:16:50 runnervmec1zy sing-box[3612]: +0000 2026-08-19 21:16:50 INFO network: updated default interface eth0, index 2
Aug 19 21:16:50 runnervmec1zy sing-box[3612]: +0000 2026-08-19 21:16:50 INFO inbound/vless[vless-reality-in]: tcp server started at [::]:443
Aug 19 21:16:50 runnervmec1zy sing-box[3612]: +0000 2026-08-19 21:16:50 INFO inbound/shadowsocks[ss2022-in]: tcp server started at [::]:8388
Aug 19 21:16:50 runnervmec1zy sing-box[3612]: +0000 2026-08-19 21:16:50 INFO inbound/shadowsocks[ss2022-in]: udp server started at [::]:8388
Aug 19 21:16:50 runnervmec1zy sing-box[3612]: +0000 2026-08-19 21:16:50 INFO sing-box started (0.00s)
```
...
drwx------ 25 root root 4096 Aug 19 21:16 ..
-rw-------  1 root root  788 Aug 19 21:16 README.txt
-rw-------  1 root root 1412 Aug 19 21:16 client-clash.yaml
-rw-------  1 root root 2350 Aug 19 21:16 client-singbox.json
-rw-------  1 root root  332 Aug 19 21:16 links.txt
-rw-------  1 root root  444 Aug 19 21:16 subscription.txt
```
