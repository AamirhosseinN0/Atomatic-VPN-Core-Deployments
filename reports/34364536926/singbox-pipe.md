# singbox-pipe (ubuntu-22.04) — run 34364536926
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 9.234.151.89
...
[+] Detected public IPv4: 9.234.151.89
...
----------------------------------------------------------------------
  Server                 vpn.example.com (9.234.151.89)
...
----------------------------------------------------------------------
  Copy the bundle to your PC
    scp -r root@9.234.151.89:/root/singbox-clients .
----------------------------------------------------------------------
...
● sing-box.service - sing-box service
    ...
    Drop-In: /etc/systemd/system/sing-box.service.d
             └─10-limits.conf
     Active: active (running) since Wed 2026-09-09 14:35:14 UTC; 2s ago
       Docs: https://sing-box.sagernet.org
   Main PID: 3003 (sing-box)
      Tasks: 9 (limit: 19154)
     Memory: 8.8M
        CPU: 58ms
     CGroup: /system.slice/sing-box.service
             └─3003 /usr/bin/sing-box -D /var/lib/sing-box -C /etc/sing-box run

Sep 09 14:35:14 runnervm7g52i systemd[1]: Started sing-box service.
Sep 09 14:35:14 runnervm7g52i sing-box[3003]: +0000 2026-09-09 14:35:14 INFO network: updated default interface eth0, index 2
Sep 09 14:35:14 runnervm7g52i sing-box[3003]: +0000 2026-09-09 14:35:14 INFO network: updated network environment: gateway 10.1.0.1, gateway_mac 12:34:56:78:9a:bc
Sep 09 14:35:14 runnervm7g52i sing-box[3003]: +0000 2026-09-09 14:35:14 INFO inbound/vless[vless-reality-in]: tcp server started at [::]:443
Sep 09 14:35:14 runnervm7g52i sing-box[3003]: +0000 2026-09-09 14:35:14 INFO inbound/shadowsocks[ss2022-in]: tcp server started at [::]:8388
Sep 09 14:35:14 runnervm7g52i sing-box[3003]: +0000 2026-09-09 14:35:14 INFO inbound/shadowsocks[ss2022-in]: udp server started at [::]:8388
Sep 09 14:35:14 runnervm7g52i sing-box[3003]: +0000 2026-09-09 14:35:14 INFO sing-box started (0.00s)
```
...
-rw-------  1 root root  786 Sep  9 14:35 README.txt
-rw-------  1 root root 1571 Sep  9 14:35 client-clash.yaml
-rw-------  1 root root 2350 Sep  9 14:35 client-singbox.json
-rw-------  1 root root  334 Sep  9 14:35 links.txt
-rw-------  1 root root  448 Sep  9 14:35 subscription.txt
```
