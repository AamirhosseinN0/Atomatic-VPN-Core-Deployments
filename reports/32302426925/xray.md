# xray (ubuntu-24.04) — run 32302426925
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 20.115.95.138
  Xray channel             latest
...
[+] Detected public IPv4: 20.115.95.138
[!] DNS: vpn.example.com -> <none> (expected 20.115.95.138); Let's Encrypt HTTP-01 may fail.
...
----------------------------------------------------------------------
  Server                 vpn.example.com (20.115.95.138)
  Xray                   26.7.28 (latest)
  Port mode              dedicated
...
----------------------------------------------------------------------
  Manage
    ...
    journalctl -u xray -f
----------------------------------------------------------------------
    scp -r root@20.115.95.138:/root/xray-clients .
----------------------------------------------------------------------
...
● xray.service - Xray Service
    ...
    Drop-In: /etc/systemd/system/xray.service.d
     ...
     Active: active (running) since Wed 2026-08-19 21:15:23 UTC; 2s ago
       Docs: https://github.com/xtls
   Main PID: 4213 (xray)
      Tasks: 9 (limit: 19164)
     Memory: 15.9M (peak: 16.0M)
        CPU: 62ms
     CGroup: /system.slice/xray.service
             └─4213 /usr/local/bin/xray run -config /usr/local/etc/xray/config.json

Aug 19 21:15:23 runnervm76f27 systemd[1]: Started xray.service - Xray Service.
Aug 19 21:15:23 runnervm76f27 xray[4213]: Xray 26.7.28 (Xray, Penetrates Everything.) 5ca6f4b (go1.26.5 linux/amd64)
Aug 19 21:15:23 runnervm76f27 xray[4213]: A unified platform for anti-censorship.
Aug 19 21:15:23 runnervm76f27 xray[4213]: 2026/08/19 21:15:23.089458 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Aug 19 21:15:23 runnervm76f27 xray[4213]: 2026/08/19 21:15:23.090999 [Warning] infra/conf: REALITY: The default minimal client version is Xray-core v26.3.27, other clients may be refused to connect
Aug 19 21:15:23 runnervm76f27 xray[4213]: 2026/08/19 21:15:23.091014 [Warning] infra/conf: REALITY: Choosing "www.microsoft.com" as the target will increase the likelihood of your server's IP being blocked by the GFW
Aug 19 21:15:23 runnervm76f27 xray[4213]: 2026/08/19 21:15:23.091942 [Warning] common/errors: The feature Shadowsocks (with no Forward Secrecy, etc.) is deprecated, not recommended for using and might be removed. Please migrate to VLESS Encryption as soon as possible.
Aug 19 21:15:23 runnervm76f27 xray[4213]: 2026/08/19 21:15:23.104159 [Warning] core: Xray 26.7.28 started
```

## Service journal (last 60 lines)
```
Aug 19 21:12:58 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:12:58 runnervm76f27 systemd[1]: Started xray.service - Xray Service.
Aug 19 21:12:58 runnervm76f27 xray[3355]: Xray 26.7.28 (Xray, Penetrates Everything.) 5ca6f4b (go1.26.5 linux/amd64)
Aug 19 21:12:58 runnervm76f27 xray[3355]: A unified platform for anti-censorship.
Aug 19 21:12:58 runnervm76f27 xray[3355]: 2026/08/19 21:12:58.651603 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Aug 19 21:12:58 runnervm76f27 xray[3355]: 2026/08/19 21:12:58.653018 [Warning] core: Xray 26.7.28 started
Aug 19 21:12:58 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:12:59 runnervm76f27 systemd[1]: Stopping xray.service - Xray Service...
Aug 19 21:12:59 runnervm76f27 systemd[1]: xray.service: Deactivated successfully.
Aug 19 21:12:59 runnervm76f27 systemd[1]: Stopped xray.service - Xray Service.
Aug 19 21:13:02 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:15:20 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:15:20 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:15:21 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:15:21 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:15:21 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:15:22 runnervm76f27 systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Aug 19 21:15:23 runnervm76f27 systemd[1]: Started xray.service - Xray Service.
Aug 19 21:15:23 runnervm76f27 xray[4213]: Xray 26.7.28 (Xray, Penetrates Everything.) 5ca6f4b (go1.26.5 linux/amd64)
Aug 19 21:15:23 runnervm76f27 xray[4213]: A unified platform for anti-censorship.
Aug 19 21:15:23 runnervm76f27 xray[4213]: 2026/08/19 21:15:23.089458 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
...
/root/xray-clients:
total 32
drwx------  2 root root 4096 Aug 19 21:15 .
drwx------ 20 root root 4096 Aug 19 21:15 ..
-rw-------  1 root root 1656 Aug 19 21:15 README.txt
-rw-------  1 root root 1667 Aug 19 21:15 client-clash.yaml
-rw-------  1 root root 2739 Aug 19 21:15 client-singbox.json
-rw-------  1 root root 2339 Aug 19 21:15 client-xray.json
-rw-------  1 root root  437 Aug 19 21:15 links.txt
-rw-------  1 root root  584 Aug 19 21:15 subscription.txt
```
