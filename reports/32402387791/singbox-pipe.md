# singbox-pipe (ubuntu-22.04) — run 32402387791
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 20.189.181.74
...
[+] Detected public IPv4: 20.189.181.74
...
----------------------------------------------------------------------
  Server                 vpn.example.com (20.189.181.74)
...
----------------------------------------------------------------------
  Copy the bundle to your PC
    scp -r root@20.189.181.74:/root/singbox-clients .
----------------------------------------------------------------------
...
● sing-box.service - sing-box service
    ...
    Drop-In: /etc/systemd/system/sing-box.service.d
             └─10-limits.conf
     Active: active (running) since Thu 2026-08-20 18:18:10 UTC; 2s ago
       Docs: https://sing-box.sagernet.org
   Main PID: 2867 (sing-box)
      Tasks: 9 (limit: 19154)
     Memory: 4.9M
        CPU: 19ms
     CGroup: /system.slice/sing-box.service
             └─2867 /usr/bin/sing-box -D /var/lib/sing-box -C /etc/sing-box run

Aug 20 18:18:10 runnervmec1zy systemd[1]: Started sing-box service.
Aug 20 18:18:10 runnervmec1zy sing-box[2867]: +0000 2026-08-20 18:18:10 INFO network: updated default interface eth0, index 2
Aug 20 18:18:10 runnervmec1zy sing-box[2867]: +0000 2026-08-20 18:18:10 INFO inbound/vless[vless-reality-in]: tcp server started at [::]:443
Aug 20 18:18:10 runnervmec1zy sing-box[2867]: +0000 2026-08-20 18:18:10 INFO inbound/shadowsocks[ss2022-in]: tcp server started at [::]:8388
Aug 20 18:18:10 runnervmec1zy sing-box[2867]: +0000 2026-08-20 18:18:10 INFO inbound/shadowsocks[ss2022-in]: udp server started at [::]:8388
Aug 20 18:18:10 runnervmec1zy sing-box[2867]: +0000 2026-08-20 18:18:10 INFO sing-box started (0.00s)
```
...
-rw-------  1 root root  787 Aug 20 18:18 README.txt
-rw-------  1 root root 1571 Aug 20 18:18 client-clash.yaml
-rw-------  1 root root 2350 Aug 20 18:18 client-singbox.json
-rw-------  1 root root  332 Aug 20 18:18 links.txt
-rw-------  1 root root  444 Aug 20 18:18 subscription.txt
```
