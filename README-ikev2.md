...
> Part of [Atomatic VPN Core Deployments](README.md) — four one-file Bash deployers.
> This one covers the IKEv2/IPsec VPN gateway; the other three deploy proxy nodes.
