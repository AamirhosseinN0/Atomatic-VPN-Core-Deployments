# singbox-pipe (ubuntu-22.04) — run 34528209784
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 20.3.231.116
...
[+] Detected public IPv4: 20.3.231.116
...
----------------------------------------------------------------------
  Server                 vpn.example.com (20.3.231.116)
...
----------------------------------------------------------------------
  Copy the bundle to your PC
    scp -r root@20.3.231.116:/root/singbox-clients .
----------------------------------------------------------------------
...
● sing-box.service - sing-box service
    ...
    Drop-In: /etc/systemd/system/sing-box.service.d
             └─10-limits.conf
     Active: active (running) since Thu 2026-09-10 20:45:19 UTC; 2s ago
...
Sep 10 20:45:19 runnervm7g52i systemd[1]: Started sing-box service.
Sep 10 20:45:19 runnervm7g52i sing-box[3054]: +0000 2026-09-10 20:45:19 INFO network: updated default interface eth0, index 2
Sep 10 20:45:19 runnervm7g52i sing-box[3054]: +0000 2026-09-10 20:45:19 INFO network: updated network environment: gateway 10.1.0.1, gateway_mac 12:34:56:78:9a:bc
Sep 10 20:45:20 runnervm7g52i sing-box[3054]: +0000 2026-09-10 20:45:20 INFO inbound/vless[vless-reality-in]: tcp server started at [::]:443
Sep 10 20:45:20 runnervm7g52i sing-box[3054]: +0000 2026-09-10 20:45:20 INFO inbound/shadowsocks[ss2022-in]: tcp server started at [::]:8388
Sep 10 20:45:20 runnervm7g52i sing-box[3054]: +0000 2026-09-10 20:45:20 INFO inbound/shadowsocks[ss2022-in]: udp server started at [::]:8388
Sep 10 20:45:20 runnervm7g52i sing-box[3054]: +0000 2026-09-10 20:45:20 INFO sing-box started (0.00s)
```
...
-rw-------  1 root root  786 Sep 10 20:45 README.txt
-rw-------  1 root root 1571 Sep 10 20:45 client-clash.yaml
-rw-------  1 root root 2350 Sep 10 20:45 client-singbox.json
-rw-------  1 root root  334 Sep 10 20:45 links.txt
-rw-------  1 root root  448 Sep 10 20:45 subscription.txt
```
