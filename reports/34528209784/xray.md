# xray (ubuntu-24.04) — run 34528209784
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 52.161.177.64
  Xray channel             latest
...
[+] Detected public IPv4: 52.161.177.64
[!] DNS: vpn.example.com -> <none> (expected 52.161.177.64); Let's Encrypt HTTP-01 may fail.
...
----------------------------------------------------------------------
  Server                 vpn.example.com (52.161.177.64)
  Xray                   26.9.9 (latest)
  Port mode              dedicated
...
----------------------------------------------------------------------
  Manage
    ...
    journalctl -u xray -f
----------------------------------------------------------------------
    scp -r root@52.161.177.64:/root/xray-clients .
----------------------------------------------------------------------
...
● xray.service - Xray Service
    ...
    Drop-In: /etc/systemd/system/xray.service.d
     ...
     Active: active (running) since Thu 2026-09-10 20:45:32 UTC; 2s ago
       Docs: https://github.com/xtls
   Main PID: 3777 (xray)
      Tasks: 9 (limit: 19151)
     Memory: 17.4M (peak: 17.4M)
        CPU: 54ms
     CGroup: /system.slice/xray.service
             └─3777 /usr/local/bin/xray run -config /usr/local/etc/xray/config.json

Sep 10 20:45:32 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 10 20:45:32 runnervmlun5p xray[3777]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 10 20:45:32 runnervmlun5p xray[3777]: A unified platform for anti-censorship.
Sep 10 20:45:32 runnervmlun5p xray[3777]: 2026/09/10 20:45:32.441680 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 10 20:45:32 runnervmlun5p xray[3777]: 2026/09/10 20:45:32.442161 [Warning] infra/conf: REALITY: Choosing "www.microsoft.com" as the target will increase the likelihood of your server's IP being blocked by the GFW
Sep 10 20:45:32 runnervmlun5p xray[3777]: 2026/09/10 20:45:32.442708 [Warning] common/errors: The feature Shadowsocks (with no Forward Secrecy, etc.) is deprecated, not recommended for using and might be removed. Please migrate to VLESS Encryption as soon as possible.
Sep 10 20:45:32 runnervmlun5p xray[3777]: 2026/09/10 20:45:32.453760 [Warning] core: Xray 26.9.9 started
```

## Service journal (last 60 lines)
```
Sep 10 20:45:22 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:22 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 10 20:45:22 runnervmlun5p xray[2970]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 10 20:45:22 runnervmlun5p xray[2970]: A unified platform for anti-censorship.
Sep 10 20:45:22 runnervmlun5p xray[2970]: 2026/09/10 20:45:22.940957 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 10 20:45:22 runnervmlun5p xray[2970]: 2026/09/10 20:45:22.941260 [Warning] core: Xray 26.9.9 started
Sep 10 20:45:23 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:24 runnervmlun5p systemd[1]: Stopping xray.service - Xray Service...
Sep 10 20:45:24 runnervmlun5p systemd[1]: xray.service: Deactivated successfully.
Sep 10 20:45:24 runnervmlun5p systemd[1]: Stopped xray.service - Xray Service.
Sep 10 20:45:28 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:29 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:30 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:30 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:30 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:31 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:32 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 20:45:32 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 10 20:45:32 runnervmlun5p xray[3777]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 10 20:45:32 runnervmlun5p xray[3777]: A unified platform for anti-censorship.
Sep 10 20:45:32 runnervmlun5p xray[3777]: 2026/09/10 20:45:32.441680 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
...
/root/xray-clients:
total 32
drwx------  2 root root 4096 Sep 10 20:45 .
drwx------ 20 root root 4096 Sep 10 20:45 ..
-rw-------  1 root root 1655 Sep 10 20:45 README.txt
-rw-------  1 root root 1826 Sep 10 20:45 client-clash.yaml
-rw-------  1 root root 2739 Sep 10 20:45 client-singbox.json
-rw-------  1 root root 2339 Sep 10 20:45 client-xray.json
-rw-------  1 root root  439 Sep 10 20:45 links.txt
-rw-------  1 root root  588 Sep 10 20:45 subscription.txt
```
