# xray (ubuntu-24.04) — run 34534610173
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 172.183.149.71
  Xray channel             latest
...
[+] Detected public IPv4: 172.183.149.71
[!] DNS: vpn.example.com -> <none> (expected 172.183.149.71); Let's Encrypt HTTP-01 may fail.
...
----------------------------------------------------------------------
  Server                 vpn.example.com (172.183.149.71)
  Xray                   26.9.9 (latest)
  Port mode              dedicated
...
----------------------------------------------------------------------
  Manage
    ...
    journalctl -u xray -f
----------------------------------------------------------------------
    scp -r root@172.183.149.71:/root/xray-clients .
----------------------------------------------------------------------
...
● xray.service - Xray Service
    ...
    Drop-In: /etc/systemd/system/xray.service.d
     ...
     Active: active (running) since Thu 2026-09-10 21:54:11 UTC; 2s ago
       Docs: https://github.com/xtls
   Main PID: 3724 (xray)
      Tasks: 9 (limit: 19151)
     Memory: 14.9M (peak: 14.9M)
        CPU: 55ms
     CGroup: /system.slice/xray.service
             └─3724 /usr/local/bin/xray run -config /usr/local/etc/xray/config.json

Sep 10 21:54:11 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 10 21:54:11 runnervmlun5p xray[3724]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 10 21:54:11 runnervmlun5p xray[3724]: A unified platform for anti-censorship.
Sep 10 21:54:11 runnervmlun5p xray[3724]: 2026/09/10 21:54:11.171264 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 10 21:54:11 runnervmlun5p xray[3724]: 2026/09/10 21:54:11.172244 [Warning] infra/conf: REALITY: Choosing "www.microsoft.com" as the target will increase the likelihood of your server's IP being blocked by the GFW
Sep 10 21:54:11 runnervmlun5p xray[3724]: 2026/09/10 21:54:11.172863 [Warning] common/errors: The feature Shadowsocks (with no Forward Secrecy, etc.) is deprecated, not recommended for using and might be removed. Please migrate to VLESS Encryption as soon as possible.
Sep 10 21:54:11 runnervmlun5p xray[3724]: 2026/09/10 21:54:11.183319 [Warning] core: Xray 26.9.9 started
```

## Service journal (last 60 lines)
```
Sep 10 21:54:02 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:02 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 10 21:54:02 runnervmlun5p xray[2893]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 10 21:54:02 runnervmlun5p xray[2893]: A unified platform for anti-censorship.
Sep 10 21:54:02 runnervmlun5p xray[2893]: 2026/09/10 21:54:02.407057 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 10 21:54:02 runnervmlun5p xray[2893]: 2026/09/10 21:54:02.407512 [Warning] core: Xray 26.9.9 started
Sep 10 21:54:02 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:03 runnervmlun5p systemd[1]: Stopping xray.service - Xray Service...
Sep 10 21:54:03 runnervmlun5p systemd[1]: xray.service: Deactivated successfully.
Sep 10 21:54:03 runnervmlun5p systemd[1]: Stopped xray.service - Xray Service.
Sep 10 21:54:06 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:08 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:08 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:09 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:09 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:09 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:11 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 10 21:54:11 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 10 21:54:11 runnervmlun5p xray[3724]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 10 21:54:11 runnervmlun5p xray[3724]: A unified platform for anti-censorship.
Sep 10 21:54:11 runnervmlun5p xray[3724]: 2026/09/10 21:54:11.171264 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
...
-rw-------  1 root root 1656 Sep 10 21:54 README.txt
-rw-------  1 root root 1826 Sep 10 21:54 client-clash.yaml
-rw-------  1 root root 2739 Sep 10 21:54 client-singbox.json
-rw-------  1 root root 2339 Sep 10 21:54 client-xray.json
-rw-------  1 root root  437 Sep 10 21:54 links.txt
-rw-------  1 root root  584 Sep 10 21:54 subscription.txt
```
