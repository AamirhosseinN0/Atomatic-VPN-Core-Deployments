# xray (ubuntu-24.04) — run 34405191591
...
----------------------------------------------------------------------
  Domain / IP              vpn.example.com / 57.154.4.166
  Xray channel             latest
...
[+] Detected public IPv4: 57.154.4.166
[!] DNS: vpn.example.com -> <none> (expected 57.154.4.166); Let's Encrypt HTTP-01 may fail.
...
----------------------------------------------------------------------
  Server                 vpn.example.com (57.154.4.166)
  Xray                   26.9.9 (latest)
  Port mode              dedicated
...
----------------------------------------------------------------------
  Manage
    ...
    journalctl -u xray -f
----------------------------------------------------------------------
    scp -r root@57.154.4.166:/root/xray-clients .
----------------------------------------------------------------------
...
● xray.service - Xray Service
    ...
    Drop-In: /etc/systemd/system/xray.service.d
     ...
     Active: active (running) since Wed 2026-09-09 21:08:50 UTC; 2s ago
       Docs: https://github.com/xtls
   Main PID: 3720 (xray)
      Tasks: 9 (limit: 19137)
     Memory: 16.0M (peak: 16.1M)
        CPU: 53ms
     CGroup: /system.slice/xray.service
             └─3720 /usr/local/bin/xray run -config /usr/local/etc/xray/config.json

Sep 09 21:08:50 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 09 21:08:50 runnervmlun5p xray[3720]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 09 21:08:50 runnervmlun5p xray[3720]: A unified platform for anti-censorship.
Sep 09 21:08:50 runnervmlun5p xray[3720]: 2026/09/09 21:08:50.068467 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 09 21:08:50 runnervmlun5p xray[3720]: 2026/09/09 21:08:50.069482 [Warning] infra/conf: REALITY: Choosing "www.microsoft.com" as the target will increase the likelihood of your server's IP being blocked by the GFW
Sep 09 21:08:50 runnervmlun5p xray[3720]: 2026/09/09 21:08:50.070145 [Warning] common/errors: The feature Shadowsocks (with no Forward Secrecy, etc.) is deprecated, not recommended for using and might be removed. Please migrate to VLESS Encryption as soon as possible.
Sep 09 21:08:50 runnervmlun5p xray[3720]: 2026/09/09 21:08:50.080943 [Warning] core: Xray 26.9.9 started
```

## Service journal (last 60 lines)
```
Sep 09 21:08:41 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:41 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 09 21:08:41 runnervmlun5p xray[2890]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 09 21:08:41 runnervmlun5p xray[2890]: A unified platform for anti-censorship.
Sep 09 21:08:41 runnervmlun5p xray[2890]: 2026/09/09 21:08:41.629761 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
Sep 09 21:08:41 runnervmlun5p xray[2890]: 2026/09/09 21:08:41.630321 [Warning] core: Xray 26.9.9 started
Sep 09 21:08:41 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:42 runnervmlun5p systemd[1]: Stopping xray.service - Xray Service...
Sep 09 21:08:42 runnervmlun5p systemd[1]: xray.service: Deactivated successfully.
Sep 09 21:08:42 runnervmlun5p systemd[1]: Stopped xray.service - Xray Service.
Sep 09 21:08:46 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:47 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:47 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:48 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:48 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:48 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:49 runnervmlun5p systemd[1]: /etc/systemd/system/xray.service:7: Special user nobody configured, this is not safe!
Sep 09 21:08:50 runnervmlun5p systemd[1]: Started xray.service - Xray Service.
Sep 09 21:08:50 runnervmlun5p xray[3720]: Xray 26.9.9 (Xray, Penetrates Everything.) 52a412d (go1.27.1 linux/amd64)
Sep 09 21:08:50 runnervmlun5p xray[3720]: A unified platform for anti-censorship.
Sep 09 21:08:50 runnervmlun5p xray[3720]: 2026/09/09 21:08:50.068467 [Info] infra/conf/serial: Reading config: &{Name:/usr/local/etc/xray/config.json Format:json}
...
-rw-------  1 root root 1654 Sep  9 21:08 README.txt
-rw-------  1 root root 1826 Sep  9 21:08 client-clash.yaml
-rw-------  1 root root 2739 Sep  9 21:08 client-singbox.json
-rw-------  1 root root 2339 Sep  9 21:08 client-xray.json
-rw-------  1 root root  437 Sep  9 21:08 links.txt
-rw-------  1 root root  584 Sep  9 21:08 subscription.txt
```
